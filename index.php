										...
										<div class="ask-item-web-card">
											<div class="front">
												<div class="cardHeader">
													<a href="<?php echo C::link('sportsDetail.php', array('detail' => base64_encode(str_replace(' ', '-', $value['sportsName']) . '+' . $value['id']) ), true);?>"><h5><?php
                          if(strlen($value['sportsName'])>20){
                            echo substr($value['sportsName'],0,20)."...";
                          }
                          else {
                            echo $value['sportsName'];
                          }
                            ?></h5></a>
											...
											<div class="back">
												<div class="cardHeader">
													<a href="<?php echo C::link('sportsDetail.php', array('detail' => base64_encode(str_replace(' ', '-', $value['sportsName']) . '+' . $value['id']) ), true);?>"><h5 style="text-transform:uppercase;"><?php
								...
								<div class="col-md-4 col-sm-4 col-xs-4 paddingbottoms">
									<div class="ask-cards">
										<div class="ask-item-web-card">
											<div class="front">
												<div class="cardHeader">
													<a href="<?php echo C::link('sadariDetails.php', array('detail' => base64_encode(str_replace(' ', '-', $value['sportsName']) . '+' . $value['id']) ), true);?>">
                            <h5>
                            <?php
								...
								<div class="col-md-4 col-sm-4 col-xs-4 paddingbottoms">
									<div class="ask-cards">
										<div class="ask-item-bonus-card">
											<div class="front">
												<div class="cardHeader">
				                                    <a href="<?php echo C::link('bonusDetail.php', array('detail' => base64_encode(str_replace(' ', '-', $value['bonusName']) . '+' . $value['id'] )), true);?>"><h5>


                    <?php

                    if(strlen($value['bonustype'])>30){
                      echo substr($value['bonustype'],0,20)."...";
                    }
                    else {
                      echo $value['bonustype'];
                    }
                     ...
                     ?>
											...
											<div class="back">
												<div class="cardHeader">
				                                    <a href="<?php echo C::link('bonusDetail.php', array('detail' => base64_encode(str_replace(' ', '-', $value['bonusName']) . '+' . $value['id'] )), true);?>">
                                              <h5 class="text-uppercase">
                                                <?php

                                                if(strlen($value['bonustype'])>20){
                                                  echo substr($value['bonustype'],0,20)."...";
                                                }
                                                else {
                                                  echo $value['bonustype'];
                        ...
                        <span class="pull-right fa fa-close info"></span>
												<div class="news-short-desc">
													<a href="<?php echo C::link('newsDetail.php', array('detail' => base64_encode(str_replace(' ', '-', $value['title']) . '+' . $value['id'] )), true);?>"><p class="text-black"><b>
